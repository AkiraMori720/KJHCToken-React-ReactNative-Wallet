...
class CryptoCurrency {
    coinName = '';
    ticker = ''; // upper case (ex. ETH)
    tickerKey = ''; // lower case (ex. eth)
    privateKeyName = '';
    explorerName = '';
    explorerLink = '';
    explorerApiKey = '';
    chainId = '';
    adminFeeObj = {
        fee: '', // percent of amount
        address: '', // where to send
        min: '' // min amount
    }
    _Web3 = null;
    cache = new Map([['addressIsContract', {}]])
    ...
    getCurrentWeb3 = () => metamask.getWeb3() || this._Web3
    ...
    getAllMyAddresses = () => {
        ...
        const metamaskAddress =
            (metamask && metamask.isConnected() && metamask.getAddress()) || ''
    ...
    getWalletByWords = (mnemonic, walletNumber = 0, path = '') => {
    ...
    send = async (params) => {
        ...
        let bufferPrivateKey = undefined
